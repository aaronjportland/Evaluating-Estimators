...
*
*	Code 01a: Population for the non-experimental evaluation of the 
*				2018 experiment (sharp RD)
*
*===============================================================================
*	Part 0: Settings
*===============================================================================
...
*===============================================================================
*	Part 2: Selecting the population that will be used in the sharp RD
*===============================================================================	
...
*===============================================================================
*	Part 3: Creating the sample (sharp RD): replacing comparison group
*===============================================================================	

/* 
the running variable is the number of employees and the treatment variable
for the sharp RD is a binary variable with value 1 if the firm was assigned to
treatment in the experiment and 0 if its number of employees is more than 10.
firms with this treatment variable equal to zero make up the new comparison 
group, which replaces the control group from the experiment.
*/
...
* creating treatment variable for the sharp RD

	g treatment_sharp_RD = 0 if treatment_assignment ==.
	
	replace treatment_sharp_RD = 1 if treatment_sharp_RD != 0
...
*===============================================================================
	...
	save "RDD/Output/RDD_output_code_01a_sharp_RD_sample.dta", replace
